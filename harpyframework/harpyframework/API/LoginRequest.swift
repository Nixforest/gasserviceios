...
//    }
     ...
     */
    func setData(username: String, password: String , uid: String) {
...
//            DomainConst.KEY_DEVICE_IMEI, identifierForVendor,
            DomainConst.KEY_DEVICE_IMEI, uid,
     ...
     * - parameter password:    Password
     */
    public static func requestLogin(action: Selector, view: BaseViewController, username: String, password: String, uid :String ) {
//        // Show overlay
//        LoadingView.shared.showOverlay(view: view.view)
        let request = LoginRequest(url: DomainConst.PATH_SITE_LOGIN,
                                   reqMethod: DomainConst.HTTP_POST_REQUEST,
                                   view: view)
        request.setData(username: username, password: password , uid: uid)
