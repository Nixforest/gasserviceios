...
//    public static let KEY_NAME_USER_REPLY               = "name_user_reply"
    ...
    /** Notify type: Spj code */
    //++
    public static let NOTIFY_TYPE_CMS_NEWS              = "TYPE_CMS_NEWS"
    //--
    /** Notify type: Gas24h  */
    public static let GAS24H_OUT_OF_GAS_TYPE            = "TYPE_GAS24H_OUT_OF_GAS"
    /** Notify type: Gas24h  */
    ...
    //++
    /** Key Stock_list */
    public static let KEY_NEWS_LIST                     = "news_list"
    /** Key Stock_list */
...
//    public static let CONTENT00526 = "Chia sẻ mã giới thiệu của bạn: %@ hoặc truy cập địa chỉ: %@"
    ...
    public static let CONTENT00594 = "Thông báo"
    public static let CONTENT00595 = "Chọn loại tin tức"
    public static let CONTENT00596 = "Chi tiết tin tức"
    public static let CONTENT00597 = "Thông báo - %@ - %@ - %@\n"
    public static let CONTENT00598 = "Dự báo lượng gas"
    public static let CONTENT00599 = "Xem bản đồ"
    //--
    //++
    public static let KEY_GAS_FORECAST                  = "gas_forecast"
    public static let TYPE_GAS_SERVICE_REMAIN           = "TYPE_GAS_SERVICE_REMAIN"
    public static let KEY_CAN_NOTIFY                    = "can_notify"
    public static let KEY_GAS_PERCENT                   = "gas_percent"
    public static let KEY_DATE_FORECAST                 = "date_forecast"
    public static let KEY_DATES_FORECAST                = "days_forecast"
    public static let KEY_DAYS                          = "days"
    public static let KEY_HOUR                          = "hour"
    public static let KEY_DATE                          = "date"
    public static let KEY_SCAN_QRCODE                   = "scan_qrcode"
    /** Schedule */
    public static let KEY_SCHEDULE                      = "schedule"
