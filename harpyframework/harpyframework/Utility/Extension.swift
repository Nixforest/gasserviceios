...
public extension NSMutableAttributedString {
    ...
    @discardableResult func small(_ text:String, _ size: CGFloat)->NSMutableAttributedString {
        let attrs:[String:AnyObject] = [NSFontAttributeName: UIFont(name: "AvenirNext-Regular", size: size)!]
        let small =  NSAttributedString(string: text, attributes:attrs)
        self.append(small)
        return self
    }
}
