...
class G15F00S02VC: BaseChildViewController {
    ...
    var PROMOTE_TEXT_REAL_WIDTH_HD  = GlobalConst.LOGIN_LOGO_HEIGHT * BaseViewController.H_RATE_HD
    var PROMOTE_TEXT_REAL_WIDTH_FHD  = GlobalConst.LOGIN_LOGO_HEIGHT * BaseViewController.H_RATE_FHD
    var PROMOTE_TEXT_REAL_WIDTH_FHD_L  = GlobalConst.LOGIN_LOGO_HEIGHT * BaseViewController.H_RATE_FHD_L
    var BANNER_REAL_HEIGHT_HD       = GlobalConst.LOGIN_LOGO_HEIGHT * BaseViewController.H_RATE_HD
    var BANNER_REAL_HEIGHT_FHD      = GlobalConst.LOGIN_LOGO_HEIGHT * BaseViewController.H_RATE_FHD
    var BANNER_REAL_HEIGHT_FHD_L    = GlobalConst.LOGIN_LOGO_HEIGHT * BaseViewController.H_RATE_FHD_L
    var BUTTON_REAL_HEIGHT_HD       = GlobalConst.LOGIN_TEXTFIELD_HEIGHT * BaseViewController.H_RATE_HD
    var BUTTON_REAL_HEIGHT_FHD      = GlobalConst.LOGIN_TEXTFIELD_HEIGHT * BaseViewController.H_RATE_FHD
    var BUTTON_REAL_HEIGHT_FHD_L    = GlobalConst.LOGIN_TEXTFIELD_HEIGHT * BaseViewController.H_RATE_FHD_L
