...
class PromotionListRequest: BaseRequest {
...
//    }
     ...
     * - parameter page:    Page index
     */
    public static func requestPromotionList(action: Selector, view: BaseViewController, page: String) {
//        // Show overlay
//        LoadingView.shared.showOverlay(view: view.view)
        let request = PromotionListRequest(url: G04Const.PATH_CUSTOMER_PROMOTION_LIST,
