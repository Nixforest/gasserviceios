...
class CCSCodeListRespModel: BaseRespModel {
    /** Total record */
    var total_record: Int = 0
    /** Total page */
    var total_page: Int = 0
    /** Record */
    var record: [CCSCodeBean] = [CCSCodeBean]()
        ...
        if let jsonData = jsonString.data(using: String.Encoding.utf8, allowLossyConversion: false) {
            do {
                ...
                for item in recordList! {
                    self.record.append(CCSCodeBean(jsonData: item))
                }
     ...
     */
    public func getRecord() -> [CCSCodeBean] {
        return self.record
    }
     ...
     */
    public func append(contentOf: [CCSCodeBean]) {
