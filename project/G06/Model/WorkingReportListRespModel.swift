//
//  WorkingReportListRespModel.swift
//  project
//
...
class WorkingReportListRespModel: BaseRespModel {
    /** Total record */
        ...
        if let jsonData = jsonString.data(using: String.Encoding.utf8, allowLossyConversion: false) {
            do {
                ...
                for item in recordList! {
                    self.record.append(WorkingReportBean(jsonData: item))
                }
     ...
     */
    public func getRecord() -> [WorkingReportBean] {
        return self.record
    }
