...
class G01F00S02HistoryCell: UITableViewCell {
    ...
    func setData(model: UpholdReplyBean, row: Int, view: BaseViewController) {
        ...
        // Label Handle date
        CommonProcess.setLayoutLeft(lbl: lblHandleDay, offset: offset,
                                    height: GlobalConst.LABEL_HEIGHT, text: DomainConst.CONTENT00150)
        // Handle date value
        CommonProcess.setLayoutRight(lbl: tbxHandleDay, offset: offset,
                                     height: GlobalConst.LABEL_HEIGHT, text: DomainConst.CONTENT00150)
        offset += GlobalConst.LABEL_HEIGHT
        
        // Label Creator
        CommonProcess.setLayoutLeft(lbl: lblCreator, offset: offset,
                                    height: GlobalConst.LABEL_HEIGHT, text: DomainConst.CONTENT00095)
        // Creator value
        CommonProcess.setLayoutRight(lbl: tbxCreator, offset: offset,
                                     height: GlobalConst.LABEL_HEIGHT, text: DomainConst.CONTENT00095)
        offset += GlobalConst.LABEL_HEIGHT
        ...
        // Status value
        CommonProcess.setLayoutRight(lbl: tbxStatus, offset: offset,
                                     height: GlobalConst.LABEL_HEIGHT, text: DomainConst.CONTENT00092)
        offset += GlobalConst.LABEL_HEIGHT
        
        // Label Created day
        CommonProcess.setLayoutLeft(lbl: lblCreatedDay, offset: offset,
                                    height: GlobalConst.LABEL_HEIGHT, text: DomainConst.CONTENT00096)
        // Created day value
        CommonProcess.setLayoutRight(lbl: tbxCreatedDay, offset: offset,
                                     height: GlobalConst.LABEL_HEIGHT, text: DomainConst.CONTENT00096)
        offset += GlobalConst.LABEL_HEIGHT
        
        // Label Note
        CommonProcess.setLayoutLeft(lbl: lblNote, offset: offset,
                                    height: GlobalConst.LABEL_HEIGHT, text: DomainConst.CONTENT00195)
        // Note value
        CommonProcess.setLayoutRight(lbl: tbxNote, offset: offset,
                                     height: GlobalConst.LABEL_HEIGHT, text: DomainConst.CONTENT00195)
        offset += GlobalConst.LABEL_HEIGHT
        
        // Label Phone
        CommonProcess.setLayoutLeft(lbl: lblPhone, offset: offset,
                                    height: GlobalConst.LABEL_HEIGHT, text: DomainConst.CONTENT00152)
        // Phone value
        CommonProcess.setLayoutRight(lbl: tbxPhone, offset: offset,
                                     height: GlobalConst.LABEL_HEIGHT, text: DomainConst.CONTENT00152)
        offset += GlobalConst.LABEL_HEIGHT
        ...
        // Intenal value
        CommonProcess.setLayoutRight(lbl: tbxInternal, offset: offset,
                                     height: GlobalConst.LABEL_HEIGHT * 2, text: DomainConst.CONTENT00151)
