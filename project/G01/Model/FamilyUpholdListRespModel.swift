//
//  FamilyUpholdListRespModel.swift
//  project
//
...
class FamilyUpholdListRespModel: BaseRespModel {
    /** Total record */
        ...
        if let jsonData = jsonString.data(using: String.Encoding.utf8, allowLossyConversion: false) {
            do {
                ...
                for item in recordList! {
                    self.record.append(FamilyUpholdBean(jsonData: item))
                }
     ...
     */
    public func getRecord() -> [FamilyUpholdBean] {
        return self.record
    }
     ...
     */
    public func append(contentOf: [FamilyUpholdBean]) {
