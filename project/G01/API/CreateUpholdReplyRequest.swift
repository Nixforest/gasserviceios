...
//            DomainConst.KEY_LONGITUDE, 0.0,
            DomainConst.KEY_LONGITUDE, String(MapViewController._currentPos.latitude),
            DomainConst.KEY_LONGITUDE, String(MapViewController._currentPos.longitude),
...
//                DomainConst.KEY_LATITUDE, 0.0,
//                DomainConst.KEY_LONGITUDE, 0.0,
                DomainConst.KEY_LATITUDE, String(MapViewController._currentPos.latitude),
                DomainConst.KEY_LONGITUDE, String(MapViewController._currentPos.longitude),
//                DomainConst.KEY_VERSION_CODE, DomainConst.VERSION_CODE,
                DomainConst.KEY_FLAG_GAS_24H, BaseModel.shared.getAppType(),
                DomainConst.KEY_CODE_COMPLETE, code_complete,
