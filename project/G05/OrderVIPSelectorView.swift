...
class OrderVIPSelectorView: UIView, UIPickerViewDelegate, UIPickerViewDataSource {
    /** Checkbox */
    ...
    */
    ...
    public func setup(frame: CGRect, checkboxLabel: String, config: ConfigBean) {
        ...
        self._button.addTarget(self, action: #selector(checkBoxTapped(_:)), for: .touchUpInside)
        ...
        let img = ImageManager.getImage(named: DomainConst.ADD_ICON_IMG_NAME)
     ...
     * Handle click event.
     */
    public func checkBoxTapped(_ sender: AnyObject) {
