...
class menuUpholdListViewController: UIViewController {
    ...
    @IBAction func gasServiceButtonTapped(_ sender: AnyObject) {
        self.dismiss(animated: false) {
            NotificationCenter.default.post(name: Notification.Name(rawValue: "gasServiceButtonInUpholdListVCTapped"), object: nil)
        }

    }
    @IBAction func issueButtonTapped(_ sender: AnyObject) {
        self.dismiss(animated: false) {
            NotificationCenter.default.post(name: Notification.Name(rawValue: "issueButtonInUpholdListVCTapped"), object: nil)
        }
    }
    @IBAction func configButtonTapped(_ sender: AnyObject) {
        self.dismiss(animated: false) {
            NotificationCenter.default.post(name: Notification.Name(rawValue: "configButtonInUpholdListVCTapped"), object: nil)
        }
    }
