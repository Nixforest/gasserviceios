//
//  StoreCardListResponseModel.swift
//  project
//
...
class StoreCardListRespModel: BaseRespModel {
    /** Total record */
        ...
        if let jsonData = jsonString.data(using: String.Encoding.utf8, allowLossyConversion: false) {
            do {
                ...
                for item in recordList! {
                    self.record.append(StoreCardBean(jsonData: item))
                }
     ...
     */
    public func getRecord() -> [StoreCardBean] {
        return self.record
    }
     ...
     */
    public func append(contentOf: [StoreCardBean]) {
