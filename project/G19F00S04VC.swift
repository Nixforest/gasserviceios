...
class G19F00S04VC: BaseParentViewController {
    /** id */
    internal var _id:                String              = DomainConst.BLANK

    @IBOutlet weak var tblCMS1: UITableView!
    /** Data CMS List*/
    ...
    override func viewDidLoad() {
        ...
        //table view
        tblCMS1.delegate = self
        tblCMS1.dataSource = self
        tblCMS1.estimatedRowHeight      = 70
        tblCMS1.rowHeight               = UITableViewAutomaticDimension
        tblCMS1.addSubview(refreshControl)
        requestCMSList()
...
extension G19F00S04VC: UITableViewDataSource{
    /**
...
extension G19F00S04VC: UITableViewDelegate {    
    /**
