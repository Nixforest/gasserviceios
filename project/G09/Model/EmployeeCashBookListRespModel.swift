//
//  EmployeeCashBookListRespModel.swift
//  project
//
...
class EmployeeCashBookListRespModel: BaseRespModel {
    /** Total record */
        ...
        if let jsonData = jsonString.data(using: String.Encoding.utf8, allowLossyConversion: false) {
            do {
                ...
                for item in recordList! {
                    self.record.append(CashBookBean(jsonData: item))
                }
     ...
     */
    public func getRecord() -> [CashBookBean] {
        return self.record
    }
     ...
     */
    public func append(contentOf: [CashBookBean]) {
